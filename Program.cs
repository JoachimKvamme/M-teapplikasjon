...
class Program
{
    static void Main(string[] args)
    {
        ...
        while(flag == true)
        {
            ...
            Console.WriteLine("For å legge til et nytt møte, skriv 'Legg til', for å slette skriv 'slett' og for å oppdatere møtedata, skriv 'oppdater'. Hvis du vil ha opp møtelisten igjen, skriv 'se'. For å gå ut av applikasjonen, skriv q eller quit.");
            ...
            switch(answer)
            {
                ...
                case "Slett":
                    ...
                    break;
                case "oppdater":
                    Console.WriteLine("Skriv inn møteId-en til det møtet du vil opddatere.");
